...
where <span style="font-family:Bodoni MT; font-style:italic;font-size:18px">T</span> is the sampling period for the analog system. This formula applies when the poles <span style="font-family:Bodoni MT; font-style:italic;font-size:18px">p<sub>i</sub></span> are all distinct.<br>
...
$$ \approx \frac{2}{T} \frac{1- z^{-1}}{1+z^{-1}}\tag{5} $$             
